...
namespace Academia
{
    public partial class Form1 : Form
    {
        ...
        private void btn_Salvar_Click(object sender, EventArgs e)//Metodo que salva os Clientes na lista
        {
            ...
            if ((bIdade) && (bGenero) && (bPeso) && (bAltura))//if que confirma se o dominio das entradas estao corretos
            {
                if ((Convert.ToInt32(textB_Genero.Text) > 0) && (Convert.ToInt32(textB_Genero.Text) < 3))//if que limita a entrada genero a 1 ou 2
                {
                    ...
                    auxCli.setIdade(Convert.ToInt32(textB_Idade.Text));//recebe a Idade do cliente e atribui o ao Cliente
        ...
        private void btn_LimparTudoClientes_Click(object sender, EventArgs e)//Botao limpa todos os campos
        {//Limpa campos
            textB_NomeCliente.Clear();
            textB_Genero.Clear();
            textB_Altura.Clear();
