...
namespace Academia
{
    public class Cliente
    {
        ...
        //Inicio get set imc e massaGorda pois tava dando erro
        public double getImc()
        {
            return this.imc;
        }

        public void setImc(double _imc)
        {
            this.imc = _imc;
        }
        ...
        public void setMassaGorda(double _massa)
        {
            this.imc = _massa;
        }
        //Fim get set imc e massaGorda pois tava dando erro
        ...
        public double calcIMC(int matrc) //IMC = peso/(altura*altura)
        {
            ...
            this.imc = IMCcalc(this.altura, this.peso);
            return this.imc;
        }

        public double IMCcalc(double _altura, double _peso) //IMC = peso/(altura*altura)
        {
            _altura = this.altura;
            _peso = this.peso;
            this.imc = this.peso / (this.altura * this.altura);
        ...
        public double calcMassaGorda(int matric, int genero) //Percentual de gordura corporal = (1,20 *IMC) + (o,23 * Idade) - (10,8 * sexo [1 mulher, 2 homem]) - 5,4
        {
            ...
            MassaGordaCalc(this.imc, this.idade, this.genero);
            return this.massaGorda;
        }

        public double MassaGordaCalc(double _imc, int _idade, int _genero) //Percentual de gordura corporal = (1,20 *IMC) + (o,23 * Idade) - (10,8 * sexo [1 mulher, 2 homem]) - 5,4
        {
            _imc = this.imc;
            _idade = this.idade;
            _genero = this.genero;
        ...
        public int calcIdade(DateTime dtNasc)//recebe uma data com dia, mes, ano e calcula a idade.
        {
